...
\title{Gestión eficiente de cadenas de suministro}
...
\hypersetup{
  pdftitle={Gesti\'{o}n eficiente de cadenas de suministro},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Gestión eficiente de cadenas de suministro}
...
\section{Etapas de la Cadena de
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Etapas de la cadena de Abastecimiento}]{index_files/figure-html/image-20250330132806207.png}}

\noindent \emph{Nota.} Adaptación~de acuerdo a Chopra y Meindel (2008)

\end{figure}

\subsection{Abastecimiento o
...
\subsection{Fabricación:}\label{fabricaciuxf3n}
...
\subsection{Consumidor:}\label{consumidor}
...
\section{Tipos de cadenas de
suministros}\label{tipos-de-cadenas-de-suministros}

\subsection{Empresas industriales:}\label{empresas-industriales}
...
\subsection{Empresas de servicios:}\label{empresas-de-servicios}

Estas cuentan con cadenas muy cortas. Es más, una cadena jerárquica y
depende del recurso humano.

\section{Ejemplo de las cadenas de suministro del
...
\section{Bibliografías}\label{bibliografuxedas}

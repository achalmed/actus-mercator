...
DELEITE S.R.L: Análisis Aplicado al Sector Pastelero}
...
\hypersetup{
  pdftitle={Sistema de Costeo por \'{O}rdenes de Producci\'{o}n en la Empresa DULCE DELEITE S.R.L},
  pdfauthor={Autor}
}
\makeatletter
...
La problemática central que aborda esta monografía es: ¿Cómo se
estructura y cuantifica el sistema de costeo por órdenes de producción
en la empresa DULCE DELEITE S.R.L para la fabricación de pasteles, y qué
implicaciones tiene esta estructura de costos para la determinación del
precio de venta y la rentabilidad empresarial?

Problemas específicos: ¿Cuál es la composición y peso relativo de cada
elemento del costo (materiales directos, mano de obra directa y gastos
indirectos) en el costo total de producción? ¿Qué metodología específica
utiliza la empresa para asignar y distribuir los costos indirectos de
fabricación? ¿Cómo se determina el precio de venta en función de la
estructura de costos identificada? ¿Qué márgenes de utilidad se obtienen
con la estructura de costos y precios actual?
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1553}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2816}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1748}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2039}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Material
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1626}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1463}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1707}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1138}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1301}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Insumo
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1635}}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0964}}
...
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.4918}}
...
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0822}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1507}}
  >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0822}}
  >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.2603}}
  >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.2466}}
...
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.3043}}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0870}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1196}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1304}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1196}}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0978}}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1413}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Fecha
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
